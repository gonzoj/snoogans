...
// res hack
FUNC(int, __attribute__((stdcall)), D2CLIENT, resize, ())
...
// res hack
FUNC(int, __attribute__((stdcall)), D2WIN, set_resolution_mode, (int mode))
...
// res hack
VAR(DWORD, D2CLIENT, width)
VAR(DWORD, D2CLIENT, height)
VAR(DWORD, D2CLIENT, map_x)
VAR(DWORD, D2CLIENT, map_y)
VAR(DWORD, D2CLIENT, crop)
VAR(DWORD, D2CLIENT, size_x1)
VAR(DWORD, D2CLIENT, size_x2)
VAR(DWORD, D2CLIENT, size_y1)
