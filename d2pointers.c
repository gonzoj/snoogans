...
// res hack
FUNC(int, __attribute__((stdcall)), D2CLIENT, resize, (), 0x3D360)
...
// res hack
FUNC(int, __attribute__((stdcall)), D2WIN, set_resolution_mode, (int mode), 0xDDB0)
...
// res hack
VAR(DWORD, D2CLIENT, width, 0xF7034)
VAR(DWORD, D2CLIENT, height, 0xF7038)
VAR(DWORD, D2CLIENT, map_x, 0x123D64)
VAR(DWORD, D2CLIENT, map_y, 0x123D60)
VAR(DWORD, D2CLIENT, crop, 0x11D070)
VAR(DWORD, D2CLIENT, size_x1, 0x11CF94)
VAR(DWORD, D2CLIENT, size_x2, 0xF703C)
VAR(DWORD, D2CLIENT, size_y1, 0x11CF98)
